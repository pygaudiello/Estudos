...
// a partir daqui tudo será da aula 4 e 5
  ...
  Nozes noz1 = Nozes("Amendoim", 3.5, "Marrom", "Oleoso", 130, 17);
  ...
  // fruta1.cozinhar(); // Erro! (Método não existe para Fruta)

  // legume1.fazerSuco(); // Erro! (Método não existe para Legume)
