...
void main() {
  ...
  // Verificando se a fruta está madura
  isMadura = funcEstaMadura(diasDesdeColheita);

  print("A fruta $nome pesa $peso gramas e é $cor. Ela é $sabor.");
  print("Ela está ${isMadura ? "madura" : "verde"}.");
}
...
class Legume extends Alimento implements Bolo {
  ...
  @override
  void assar() {
    print("Assando o legume.");
  }

  @override
  void fazerMassa() {
    print("Preparando o legume.");
  }

  @override
  void separarIngredientes() {
    print("Separando os ingredientes do legume.");
  }
}
